...
class Menu(Frame):
    def __init__( self, parent, controller ):
        ...
        level_1_label = Button(self, text = "Level 1", image = self.level_1, bg = "#b3ebf2", highlightthickness=0, borderwidth=0, activebackground="#b3ebf2").place(relx = 0.5, rely = 0.45, anchor = "center")
        ...
        level_2_label = Button(self, text = "Level 2", image = self.level_2, bg = "#b3ebf2", highlightthickness=0, borderwidth=0, activebackground="#b3ebf2").place(relx = 0.5, rely = 0.6, anchor = "center")
